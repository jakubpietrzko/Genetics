...
public class Tiny_gp {
    ...
    static PrintStream originalOut = System.out; // Zapisuje oryginalny strumień wyjściowy
    ...
    public static void setOutputToFile(String filename) {
        try {
            ...
            System.out.println("Błąd podczas ustawiania strumienia wyjściowego do pliku: " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    int print_indiv( char []buffer, int buffercounter ) {
        ...
        if ( buffer[buffercounter] < FSET_START ) {
            if ( buffer[buffercounter] < varnumber )
                ...
                System.out.printf("%.4f", x[buffer[buffercounter]]);
    ...
    public static void main(String[] args) {
        String fname = "C:\\Users\\kubap\\Desktop\\Projekty\\genetyczne\\skrypty\\5x3-2x2itd.dat";
        long s = -1;
        ...
        // Ustawienie pliku wyjściowego (output.txt)
        setOutputToFile("output.txt");
